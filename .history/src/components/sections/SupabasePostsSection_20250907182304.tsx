        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {posts.length === 0 ? (
              ...
              posts.map((post) => (
                <div key={post.id} className="group relative bg-card/50 border border-form-container-border rounded-lg hover:bg-card/80 transition-all duration-200">
                  <div className="p-4">
