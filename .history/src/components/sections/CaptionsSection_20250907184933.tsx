...
export const CaptionsSection: React.FC = () => {
  ...
  const loadCaptions = async () => {
    try {
      ...
      // Debug: log all script types
      console.log('All scripts:', scriptsData);
      console.log('Script types:', scriptsData.map(s => s.type));
      ...
      console.log('Filtered captions:', captionsData);
